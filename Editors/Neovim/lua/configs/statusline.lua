...
local create_separator = function(direction)
    return {
        provider = function() return get_icon("separator_" .. direction) end,
    }
end
...
section.left[2] = { SeparatorRight = separator_right }
...
-- Position
section.right[3] = { SeparatorLeft = separator_left }
section.right[4] = {
    Position = {
        provider = function()
            return fileinfo.line_column() .. extension.scrollbar_instance() ..
