...
1. **Understand & Expand _(Divergent)_:** Restate the idea, ask sharpening questions, and generate variations.
...
This skill is primarily an interactive dialogue.
...
- _"Help me refine this idea"_
- _"Ideate on {concept}"_
- _"Stress-test my plan"_

---

## Output

The final output is a markdown one-pager saved to `docs/ideas/[idea-name].md` _(after user confirmation)_,
containing:
