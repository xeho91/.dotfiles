...
**Bad:** One commit that adds a new component, refactors an existing one, and updates the build configuration.
...
Per-increment verification is the local check.
Before declaring a task done, apply the project-wide Definition of Done as the final gate,
the standing bar every increment clears regardless of the task. See `../../references/definition-of-done.md`.
